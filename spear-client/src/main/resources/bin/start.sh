...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS com.sumory.gru.spear.client.Main $1 $2 $3 $4 $5 > $STDOUT_FILE 2>&1 &
